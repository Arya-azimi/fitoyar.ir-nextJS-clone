...
export function StepPersonalInfo() {
  ...
  return (
    <div>
      ...
      <h3 className="text-lg font-medium mb-4">جنسیت</h3>
      ...
      <h3 className="text-lg font-medium my-6">سن (سال)</h3>
      <input
        type="number"
        placeholder="مثال: 25"
      ...
      <h3 className="text-lg font-medium my-6">قد (سانتی‌متر)</h3>
      <input
        type="number"
      ...
      <h3 className="text-lg font-medium my-6">وزن فعلی (کیلوگرم)</h3>
      <input
        type="number"
        placeholder="مثال: 85"
        className={inputClasses}
