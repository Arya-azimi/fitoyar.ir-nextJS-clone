...
export function HeaderUI({ categoryTree }: Props) {
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  return (
    <>
      <header className="w-full flex justify-center p-4">
        <div className="w-full max-w-6xl">
          <div className="md:hidden bg-gray-100 backdrop-blur-sm rounded-2xl p-5 flex justify-between items-center">
            <button
          ...
          <div className="hidden md:flex flex-col items-center">
            <div className="w-full bg-gray-100 backdrop-blur-sm rounded-2xl p-5 flex justify-between items-center">
              <Link href="/">
                <Image
                  src="https://fitoyar.ir/wp-content/uploads/2022/05/Vector-5-2.svg"
                  alt="فیتویار لوگو"
